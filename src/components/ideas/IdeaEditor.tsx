  ...
  return (
    <div className="bg-white/5 border border-white/10 rounded-2xl p-6 space-y-6">
      ...
      <div className="flex items-center justify-between border-b border-white/10 pb-4">
        <h3 className="text-lg font-semibold">Edit Working Idea</h3>
        <div className="flex items-center gap-3">
          ...
          {onMinimize && (
            <button
              onClick={onMinimize}
              className="px-3 py-1 text-xs text-white/70 hover:text-white hover:bg-white/5 border border-white/10 rounded transition-colors"
      ...
      <div>
        ...
        <input
          ...
          className="w-full px-4 py-2.5 bg-white/5 border border-white/10 rounded-lg focus:border-brand focus:outline-none transition-colors"
        />
      </div>
      ...
      <div>
        ...
        <textarea
          ...
          rows={3}
          className="w-full px-4 py-2.5 bg-white/5 border border-white/10 rounded-lg focus:border-brand focus:outline-none transition-colors resize-none"
        />
      </div>
      ...
      <div>
        ...
        <textarea
          ...
          rows={8}
          className="w-full px-4 py-2.5 bg-white/5 border border-white/10 rounded-lg focus:border-brand focus:outline-none transition-colors resize-none font-mono text-sm"
        />
      </div>
